export const en = {
  ...
  contact: {
    ...
    newChamberTitle: 'New Chamber',
    newChamberDesc: 'Apon Digonistic center (Every Friday), Matirangga Bazar, Khagrachari.',
    newChamberPhone: 'Serial: 01585-875229',
    phone: 'Serial Number',
    email: 'Email',
...
export const bn = {
  ...
  contact: {
    ...
    newChamberTitle: 'নতুন চেম্বার',
    newChamberDesc: 'আপন ডায়াগনস্টিক সেন্টার (প্রতি শুক্রবার), মাটিরাঙ্গা বাজার, খাগড়াছড়ি।',
    newChamberPhone: 'সিরিয়াল: ০১৫৮৫-৮৭৫২২৯',
    phone: 'সিরিয়াল',
    email: 'ইমেইল',
